...
| [M3-05](docs/tasks/M3-05-size-startup-memory-benchmarks.md) | 阻塞 | Host、Build、Governance、API 29 KVM 与 API 36 完整报告已生成；API 36 的 `kotlin-multidex` Application.onCreate P50 增量为 331 ms，超过固定 300 ms 预算，且两轮 Android 汇总有 6 项超过 10% 重复性门禁；等待独立启动性能优化/测量稳定性任务，未运行 ARM 真机、未合并 PR #63 |
