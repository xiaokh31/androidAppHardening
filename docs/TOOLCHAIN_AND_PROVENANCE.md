...
GitHub 的 `windows-2025` 托管池会在滚动发布期间分配多个已发布镜像，因此 M2-07 Windows Host 使用精确、有限且机器锁定的不可变 allowlist：runtime `ImageVersion=20260728.188.1` 对应 [manifest ref `win25-vs2026/20260728.188`](https://github.com/actions/runner-images/blob/win25-vs2026/20260728.188/images/windows/Windows2025-VS2026-Readme.md)，`ImageVersion=20260803.193.1` 对应 [manifest ref `win25-vs2026/20260803.193`](https://github.com/actions/runner-images/blob/win25-vs2026/20260803.193/images/windows/Windows2025-VS2026-Readme.md)，`ImageVersion=20260810.198.2` 对应 [manifest ref `win25-vs2026/20260810.198`](https://github.com/actions/runner-images/blob/win25-vs2026/20260810.198/images/windows/Windows2025-VS2026-Readme.md)。第三份 ref 固定到 commit `9669462631cac120f4f558e7dadd31a14d1f1a41`，清单文件 blob 为 `e5e0527a4cc19153e7e8daf98780ff18e7062ac1`。三份清单均固定 LLVM/`clang-cl` `20.1.8`、Visual Studio Enterprise 2026 `18.8.12023.21`（x64 tools component `18.8.11901.359`）与 Windows SDK `10.0.26100.0`；项目继续固定 CMake/Ninja `4.1.2`，CI 逐字断言实际 `cl.exe` runtime `19.51.36252`。workflow 精确映射 runtime 到清单 ref 并逐项断言编译器环境；不接受范围、任何未列入镜像或 `latest`，托管池出现新值时失败关闭并要求独立工具链复核。

M2-07 Ubuntu Host、KVM 与跨平台等价任务固定到 run 自报的 `ImageOS=ubuntu24`，并使用精确、有限且机器锁定的不可变 allowlist：runtime `ImageVersion=20260720.247.2` 对应[清单 ref `ubuntu24/20260720.247`](https://github.com/actions/runner-images/blob/ubuntu24/20260720.247/images/ubuntu/Ubuntu2404-Readme.md)，`ImageVersion=20260804.265.1` 对应[清单 ref `ubuntu24/20260804.265`](https://github.com/actions/runner-images/blob/ubuntu24/20260804.265/images/ubuntu/Ubuntu2404-Readme.md)，`ImageVersion=20260810.271.1` 对应[清单 ref `ubuntu24/20260810.271`](https://github.com/actions/runner-images/blob/ubuntu24/20260810.271/images/ubuntu/Ubuntu2404-Readme.md)，`ImageVersion=20260816.277.1` 对应[清单 ref `ubuntu24/20260816.277`](https://github.com/actions/runner-images/blob/ubuntu24/20260816.277/images/ubuntu/Ubuntu2404-Readme.md)。四份清单均提供 GNU C/C++ `13.3.0`；workflow 精确映射 runtime 到清单 ref、输出所选 ref 并断言编译器版本。机器锁 `ci_toolchains.ubuntu` 固定顺序、runner label、四个 runtime/ref、编译器命令与版本，字段、映射或顺序变更均由负例拒绝；不接受范围、第五个镜像或 `latest`，托管池再出现新值时必须失败关闭并重新审查。
...
其中 2026-08-20 锁维护新增且只新增第四项 runtime `ImageVersion=20260816.277.1`。其官方轻量 tag 指向 commit `3b5f596ffecb076aa5f3c3ded95b145f6daeb016`、tree `121399991e96a26a7786143484d7f71c79a189b5`；manifest `images/ubuntu/Ubuntu2404-Readme.md` 的 blob 为 `0023ec0741a8c708f9ba2e2bcfc1ee0d9fcb219c`，长度 `15740` bytes，SHA-256 `50384bd5268bb03ae44ab93d621d9d9f20b30f8f0c8155ed49333a57c31a7d88`。该清单明确提供 GNU C/C++ `13.3.0`、Clang `18.1.3`、CMake `4.1.2` 与 NDK `29.0.14206865`；M3-02 fuzz 锁使用同一精确 runtime/ref。
