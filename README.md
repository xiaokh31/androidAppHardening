...
| [M3-14](docs/tasks/M3-14-successor-startup-diagnostic.md) | 已阻塞 | Issue #82 / Draft PR #83；唯一 run `32611656930` 在 profile-lock preflight 失败，零样本/零 artifact；terminal run `32612414400` fail-closed，禁止重试或续期 |
| [M3-05](docs/tasks/M3-05-size-startup-memory-benchmarks.md) | 已阻塞 | PR #63 不再运行 API 36 A/B 或 ARM；M3-14 未产生 owner，且 ADR 0018 禁止替代结果或再次续期 |
