...
M0 基础建设与可行性验证已经完成，项目正在顺序执行 M1 Host 处理链。当前仍未提供端到端可用的 APK 加固程序：M1-01 输入检查、M1-02 signer policy 和 M1-03 Binary AXML 转换器已经合并，M1-07 的 AHDC v2 分块认证容器合同已完成本地全零独立复核，正在等待发布与合并；M1-04 容器实现必须等 M1-07 合并后重新启动。
...
| [M1-07](docs/tasks/M1-07-chunk-authenticated-container-contract.md) | 待发布/合并 | AHDC v2 合同已通过独立复核，Issue #36；合并前 M1-04 保持阻塞 |
