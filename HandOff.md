...
1. Freeze the review-1 remediation while keeping both canonical workflow paths absent, then obtain a second independent read-only `P0=0/P1=0/P2=0` review.
2. Only after all-zero review, push that unchanged workflow-absent freeze, create the unique Issue #82 draft PR, and require exact-head Ubuntu/Windows Build plus Governance to pass.
