...
| M3-14 | `/root` | `feat/m3-14-successor-startup-diagnostic` | blocked | M3-09, M3-11, M3-12, M3-13 | Run `32611656930` consumed attempt 1, diagnostic step failed and artifact count is zero; terminal run `32612414400` step 6 failed and artifact count is zero; no retry or renewal |
