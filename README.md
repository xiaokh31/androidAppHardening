...
| [M3-11](docs/tasks/M3-11-canonical-startup-artifact-contract.md) | 进行中 | Issue #71；固定 PR #63 run `31931428130`/artifact `9260244215` 中实际测量 APK 的不可变来源、SHA-256 与 tuple；不运行 build/device/benchmark |
