...
| [M3-14](docs/tasks/M3-14-successor-startup-diagnostic.md) | 已阻塞 | Issue #82 / Draft PR #83；唯一 run `32611656930` 的诊断步骤失败、上传跳过且 artifact=0；terminal run `32612414400` fail-closed，禁止重试或续期 |
