...
post-merge `main` 的 Windows Build 与 Ubuntu/Windows Governance 已通过；Ubuntu Build 在项目构建前因 hosted-runner 更新为尚未复核的 `20260816.277.1` 而失败关闭。该工具链锁必须通过独立维护任务复核，不能重跑或豁免绕过。
