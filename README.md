...
| [M2-07](docs/tasks/M2-07-native-crypto-backend.md) | 已完成 | PR #42/Issue #41 完成 Native 密码后端；PR #51/Issue #50 与 PR #74/Issue #73 分别完成 Windows `20260810.198.2` 与 Ubuntu `20260816.277.1` runner 精确锁维护；独立全零复核、双平台 Build/Governance 与 strict HandOff 均已关闭 |
...
| [M3-12](docs/tasks/M3-12-profile-package-retention.md) | 进行中 | Issue #75；固定已复核 profile package 的 numeric release/asset ID、archive/member SHA-256；禁止再生和 Android 执行 |
| [M3-10](docs/tasks/M3-10-startup-attribution-diagnostic.md) | 已阻塞 | 实现复核已全零；等待 M3-12 远端 profile asset 合同独立全零复核并合并后，才可创建唯一 API 36 workflow |
