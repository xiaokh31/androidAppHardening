...
GitHub 的 `windows-2025` 托管池会在滚动发布期间分配多个已发布镜像，因此 M2-07 Windows Host 使用精确、有限且机器锁定的不可变 allowlist：runtime `20260728.188.1`、`20260803.193.1`、`20260810.198.2` 与 `20260818.207.1` 分别绑定 manifest ref `win25-vs2026/20260728.188`、`win25-vs2026/20260803.193`、`win25-vs2026/20260810.198` 与 `win25-vs2026/20260818.207`。第四份官方 manifest 的轻量 tag 指向 commit `0900c002193dc2d3fade0cd9133ae70e7088eb05`、tree `4c1d1f41940febb68702c0ffc28fa84723097019`；manifest blob `4a994e86af753335ce0a1f7839414656048ac8d9` 为 `34156` bytes，SHA-256 `4cd6067bec8e0eb5ac04e1134fb71f23b99ca296caeab1cc5d30ca4838e218ba`。前三个 runtime 各自绑定 Visual Studio Enterprise 2026 `18.8.12023.21`、x64 tools `18.8.11901.359` 与运行时 `cl.exe 19.51.36252`；第四个绑定 `18.9.12112.369`、`18.9.12009.112` 与 PR #78 Windows job `96970786197` 实测的 `cl.exe 19.51.36256`。四者共用锁定的 LLVM/`clang-cl` `20.1.8`、Windows SDK `10.0.26100.0` 与 CMake/Ninja `4.1.2`。workflow 必须先按 runtime 选择完整记录，再逐项断言 manifest、VS、x64 tools、该镜像的 `cl.exe`、SDK 与 clang；不接受范围、跨镜像值、任何未列入镜像或 `latest`。
