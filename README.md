...
| [M3-13](docs/tasks/M3-13-successor-diagnostic-identity-contract.md) | 进行中 | Issue #80；ADR 0018 固定唯一 successor identity、全历史 qualification 与不可再次续期；本任务不运行 Android |
