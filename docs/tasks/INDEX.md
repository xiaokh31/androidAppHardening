...
| M3-09 | [#68](https://github.com/xiaokh31/androidAppHardening/issues/68) | [End-to-end startup attribution boundary contract](M3-09-startup-attribution-boundary-contract.md) | `qa-governance-agent` | M3-08 |
| M3-11 | [#71](https://github.com/xiaokh31/androidAppHardening/issues/71) | [Canonical startup diagnostic artifact contract](M3-11-canonical-startup-artifact-contract.md) | `qa-governance-agent` | M3-09 |
...
| M3-14 | [#82](https://github.com/xiaokh31/androidAppHardening/issues/82) | [ADR 0018 successor startup diagnostic implementation](M3-14-successor-startup-diagnostic.md) | `runtime-security-agent` | M3-09, M3-11, M3-12, M3-13 |
| M3-05 | [#22](https://github.com/xiaokh31/androidAppHardening/issues/22) | [Size, startup, and memory benchmarks](M3-05-size-startup-memory-benchmarks.md) | `qa-governance-agent` | M1-06, M2-04, M2-06, M3-01, M3-07, M3-08, M3-09, M3-13, M3-14 |
...
M2-06 + M3-01 → M3-03
M2-05 + M2-06 + M3-01 → M3-07 → M3-08 → M3-09 → M3-11 → M3-12 → M3-10 → M3-13 → M3-14 → owner remediation → M3-05
