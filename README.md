...
| [M3-10](docs/tasks/M3-10-startup-attribution-diagnostic.md) | 已阻塞 | 全零复核后的 first-and-only run `32554806537` 在设备前因浅克隆缺少 M3-12 ancestry 而失败，无 artifact/归因；terminal run `32554917303` fail-closed，当前 tuple 禁止重跑 |
