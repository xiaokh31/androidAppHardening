...
| M3-11 | Canonical 启动诊断 APK 来源与哈希合同 | M3-09 |
| M3-12 | 诊断 profile package 远端保留合同 | M3-11 |
| M3-10 | ADR 0016 启动归因诊断实现 | M3-09, M3-11, M3-12 |
| M3-13 | ADR 0018 successor diagnostic identity 合同 | M3-09, M3-11, M3-12 |
| M3-15 | 终态诊断与 v0.1 发布路线处置 | M3-13 |
| M3-05 | 大小、冷启动、内存基准与预算 | M1-06, M2-04, M2-06, M3-01, M3-07, M3-08, M3-09, M3-13 |
...
当前 v0.1 release line 已由 ADR 0019 选择终态停止：M3-15 不补足 M3-05 证据，不解除 M4 依赖，也不允许以其他平台替代已消耗的诊断。
...
当前路线状态为不可启动。只有新的版本化 product tuple、新 ADR 和新任务图可以建立未来发布路线；当前 M4 任务不得用 M3-15 文档替代缺失的 M3-05 证据。
