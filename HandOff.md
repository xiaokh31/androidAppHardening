...
- M3-14 run `32611656930` consumed the only API 36 x86_64 `runAttempt=1` and failed before campaigns with zero artifacts; terminal evidence run `32612414400` independently rejected that missing artifact.
