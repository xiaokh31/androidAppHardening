...
val m310VerifyProfiles by tasks.registering(JavaExec::class) {
    ...
    argumentProviders.add(
        objects.newInstance(M310VerifyArguments::class).apply {
            originalBaseline.set(providers.gradleProperty("m314OriginalBaseline"))
            originalProtected.set(providers.gradleProperty("m314OriginalProtected"))
            profileBaseline.set(providers.gradleProperty("m314ProfileBaseline"))
            profileProtected.set(providers.gradleProperty("m314ProfileProtected"))
            observerDex.set(providers.gradleProperty("m314ObserverDex"))
            derivationManifest.set(providers.gradleProperty("m314DerivationManifest"))
            profileLock.set(providers.gradleProperty("m314ProfileLock"))
            report.set(providers.gradleProperty("m314VerificationReport"))
        },
    )
}
