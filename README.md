...
| [M3-09](docs/tasks/M3-09-startup-attribution-boundary-contract.md) | 进行中 | Issue #68；ADR 0016 重新固定端到端与 Runtime 内层归因边界，本任务仅做治理文档/验证，不运行 benchmark、KVM 或 ARM |
