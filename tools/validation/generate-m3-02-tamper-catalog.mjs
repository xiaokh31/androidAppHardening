...
const cases = [
  ...
  host("m302-container-major", "container-host", "version", "CONTAINER_HEADER", "CONTAINER_VERSION"),
  host("m302-container-header-length", "container-host", "payload_length", "CONTAINER_HEADER", "CONTAINER_FORMAT"),
  host("m302-container-record-overlap", "container-host", "record_length", "CONTAINER_RECORDS", "CONTAINER_FORMAT"),
  host("m302-container-chunk-order", "container-host", "chunk_ordinal", "CONTAINER_CHUNKS", "CONTAINER_FORMAT"),
