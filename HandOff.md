...
handoff_id: HO-20260817-022438
updated_at: 2026-08-17T02:24:38+08:00
updated_by: /root
state: active
...
|---|---|---|---|---|---|
| M2-10 | `/root` | `fix/m2-10-runtime-startup-performance` | in_progress | M2-01, M2-02, M2-03, M2-05, M2-06, M3-08 | Implement and freeze the first-and-only API 36 diagnostic without running it or changing production Runtime prematurely |
...
1. Implement the test-only first-start `t0..t6` observer, report/manifest/raw-sample validator and mutation negatives; statically prove it is absent from Release surfaces. Do not trigger the diagnostic yet.
2. Freeze and review diagnostic implementation, then trigger its first and only API 36 run/job/attempt/boot for the frozen pre-optimization product bytes.
