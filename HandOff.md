...
- M3-13 cannot be published or merged until its local governance/mutation gates pass, an independent read-only review returns `P0=0/P1=0/P2=0`, and the user separately authorizes push/PR publication.
