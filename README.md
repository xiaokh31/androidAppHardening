...
| [M2-07](docs/tasks/M2-07-native-crypto-backend.md) | 维护中 | PR #42/Issue #41 完成 Native 密码后端；PR #51/Issue #50 与 PR #74/Issue #73 已锁定 Windows `20260810.198.2` 和 Ubuntu `20260816.277.1`；Issue #77/PR #78 正在独立锁定 Windows `20260818.207.1` 的 runtime/ref 与逐镜像 VS/x64 tools/`cl.exe`，完成前 PR #76 Build 保持失败关闭 |
...
| [M3-10](docs/tasks/M3-10-startup-attribution-diagnostic.md) | 已阻塞 | 等待 M3-11 合并及 exact canonical pair 的可安装 profile 派生/签名方案通过独立复核；不得复用 rejected rebuilt fixture |
