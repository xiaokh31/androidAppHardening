...
| [M2-06](docs/tasks/M2-06-memory-dump-cost-controls.md) | 合并待审 | PR #48、Issue #17、P0/P1/P2 全零独立复核、Ubuntu/Windows、API 29/36 KVM、Release/R8、清零/只读/`DONTDUMP`/锁页/抖动门禁均已关闭；待 ready、合并和 post-merge strict HandOff |
