...
| [M3-08](docs/tasks/M3-08-startup-performance-stability-contract.md) | 合并收尾中 | PR #65 已以 expected-head 合并；独立全零复核、45 个负例、双平台 Build/Governance 已通过，等待 post-merge `main` 门禁 |
