...
M2-07 Ubuntu runner 精确锁维护已关闭先前工具链阻塞；PR #74 的 exact-head 及合并后 `main` Build 均在 Ubuntu/Windows 通过。GitHub 后续分配的 Windows `20260818.207.1` 已由 Issue #77 独立进入 runtime/ref 与逐镜像 VS/x64 tools 固定流程；复核和合并前 PR #76 Build 保持失败关闭，不通过重跑或豁免绕过。
...
| [M2-07](docs/tasks/M2-07-native-crypto-backend.md) | 维护中 | PR #42/Issue #41 完成 Native 密码后端；PR #51/Issue #50 与 PR #74/Issue #73 已锁定 Windows `20260810.198.2` 和 Ubuntu `20260816.277.1`；Issue #77 正在独立锁定 Windows `20260818.207.1` 的 runtime/ref 与逐镜像 VS/x64 tools，完成前 PR #76 Build 保持失败关闭 |
